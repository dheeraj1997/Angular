...
@Component({
  selector: 'app-school-admin-student-edit',
  templateUrl: './school-admin-student-edit.component.html',
  styleUrls: ['./school-admin-student-edit.component.scss']
})
export class SchoolAdminStudentEditComponent implements OnInit {
  schoolData = {
    _id: ''
  };
  userData = {
