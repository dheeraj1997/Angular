...
@Component({
  selector: 'app-school-registrar-student-add',
  templateUrl: './school-registrar-student-add.component.html',
  styleUrls: ['./school-registrar-student-add.component.scss']
})
export class SchoolRegistrarStudentAddComponent implements OnInit {
      ...
      .subscribe(res => {
        ...
        if (res && res.data && res.data._id) {
          ...
          if (!res.data.currentSession) {
            this.alert.info('No current session found. Please contact your admin!');
            this.router.navigate(['/school/registrar/dashboard']);
          }
