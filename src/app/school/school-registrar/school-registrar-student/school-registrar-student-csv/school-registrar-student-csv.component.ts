...
@Component({
  selector: 'app-school-registrar-student-csv',
  templateUrl: './school-registrar-student-csv.component.html',
  styleUrls: ['./school-registrar-student-csv.component.scss']
})
export class SchoolRegistrarStudentCsvComponent implements OnInit {
