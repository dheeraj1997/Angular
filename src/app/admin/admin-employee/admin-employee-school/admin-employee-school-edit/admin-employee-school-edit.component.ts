...
@Component({
  selector: 'app-admin-employee-school-edit',
  templateUrl: './admin-employee-school-edit.component.html',
  styleUrls: ['./admin-employee-school-edit.component.scss']
})
export class AdminEmployeeSchoolEditComponent implements OnInit {
  userData = {
    _id: ''
  };
    ...
    if (
      ...
      this.school.editSchool(this.schoolData)
        ...
        .subscribe(res => {
          ...
          this.router.navigate(['/admin/employee/school/view'])
        }, err => {
          err = err.json();
          console.log('err', err);
