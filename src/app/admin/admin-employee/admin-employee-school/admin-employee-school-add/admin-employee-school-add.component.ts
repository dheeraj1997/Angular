...
@Component({
  selector: 'app-admin-employee-school-add',
  templateUrl: './admin-employee-school-add.component.html',
  styleUrls: ['./admin-employee-school-add.component.scss']
})
export class AdminEmployeeSchoolAddComponent implements OnInit {
  userData = {
    _id: ''
  };
  boardOptions = [
