...
@Component({
  selector: 'app-admin-organization-school-edit',
  templateUrl: './admin-organization-school-edit.component.html',
  styleUrls: ['./admin-organization-school-edit.component.scss']
})
export class AdminOrganizationSchoolEditComponent implements OnInit {
  userData = {
    _id: ''
  };
  boardOptions = [
